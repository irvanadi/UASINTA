...
public class DecisionAdapter extends RecyclerView.Adapter<DecisionAdapter.ViewHolder> {
    ...
    public DecisionAdapter(Context context, ArrayList<ResultAPI> results) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_decision, parent, false);
